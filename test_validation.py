...
def test_simple_pass(restore_original_json: str) -> None:
...
def test_simplest_pass(restore_original_json: str) -> None:
...
def test_schema_violation_dict1(restore_original_json: str) -> None:
...
def test_schema_violation_dict2(restore_original_json: str) -> None:
...
def test_schema_violation_dict3(restore_original_json: str) -> None:
...
def test_simple_duplicate_detection(restore_original_json: str) -> None:
...
def test_simple_duplicate_detection2(restore_original_json: str) -> None:
...
def test_subset_duplicate_detection(restore_original_json: str) -> None:
...
def test_case_sensitivity(restore_original_json: str) -> None:
...
def test_duplicate_case_insensitive_detection(restore_original_json: str) -> None:
